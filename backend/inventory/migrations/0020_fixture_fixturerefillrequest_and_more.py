    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Inactive fixtures are hidden from scanning",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["fixture", "status"],
                        name="inventory_f_fixture_15ad6a_idx",
                    ),
                    models.Index(
                        fields=["status", "-requested_at"],
                        name="inventory_f_status_ae296c_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="fixture",
            index=models.Index(
                fields=["refill_item"], name="inventory_f_refill__228979_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="fixture",
            index=models.Index(
                fields=["asset_tag"], name="inventory_f_asset_t_5bf411_idx"
            ),
        ),
    ]
