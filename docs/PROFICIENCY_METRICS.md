...
| Critical path                                              | Coverage | Owner test(s)                                                                                                |
| ---------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------ |
| Inventory browse + search                                  | unit       | `frontend/src/__tests__/pages/InventoryListPage.test.tsx`, `InventoryItemDetailPage.test.tsx`. e2e: gap.   |
...
| ------------------------------------------------- | ---------------- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Critical-path e2e coverage                        | 100% of `docs/FRONTEND_JOURNEY_INVENTORY.md` rows have a Playwright spec | Partial — `frontend/e2e/` covers public-to-staff loop, asset-scan, admin-dashboard-assets, and SIG dashboard; inventory browse, reorder triage, work-order review, and ForgeKey e2e are gaps | Run `frontend/e2e` and cross-reference inventory.                          |
