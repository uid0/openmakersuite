...
def create_locations_from_existing_data(apps, schema_editor):
    ...
    unique_locations = InventoryItem.objects.values_list(
        "location_old", flat=True
    ).distinct()
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            create_locations_from_existing_data, reverse_code=migrations.RunPython.noop
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "supplier_sku",
                    models.CharField(
                        help_text="Supplier's product SKU/ID", max_length=100
                    ),
                ),
                (
                    "supplier_url",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=7,
                        help_text="Average lead time in days from this supplier",
                    ),
                ),
                (
                    "is_primary",
                    models.BooleanField(
                        default=False,
                        help_text="Preferred/primary supplier for this item",
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True,
                        help_text="Whether this supplier option is currently active",
                    ),
                ),
                (
                    "notes",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["item", "is_primary"], name="inventory_i_item_id_872ceb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="itemsupplier",
            index=models.Index(
                fields=["item", "unit_cost"], name="inventory_i_item_id_cae73f_idx"
            ),
        ),
    ]
