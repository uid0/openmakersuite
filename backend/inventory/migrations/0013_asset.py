    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(help_text="Asset name or model", max_length=200)),
                (
                    "description",
                ...
                (
                    "date_received",
                    models.DateField(
                        blank=True, help_text="Date the asset was received or acquired", null=True
                    ),
                ),
                (
                    "amount_paid",
                ...
                (
                    "is_donation",
                    models.BooleanField(default=False, help_text="Check if this asset was donated"),
                ),
                (
                    "donor_name",
                    models.CharField(
                        blank=True, help_text="Name of donor (if applicable)", max_length=200
                    ),
                ),
                (
                    "product_url",
                    models.URLField(blank=True, help_text="Link to product page or documentation"),
                ),
                (
                    "image",
                    models.ImageField(
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Inactive assets are hidden from most views"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["serial_number"], name="inventory_a_serial__4865f1_idx"),
                    models.Index(fields=["asset_tag"], name="inventory_a_asset_t_f5ad3d_idx"),
                    models.Index(fields=["status"], name="inventory_a_status_69dd7e_idx"),
                    models.Index(fields=["manufacturer"], name="inventory_a_manufac_4dfc0e_idx"),
                ],
            },
        ),
    ]
