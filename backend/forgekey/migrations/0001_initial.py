...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Device type name", max_length=50, unique=True
                    ),
                ),
                (
                    "code",
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of this device type"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Is this device type active?"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, help_text="When usage started"
                    ),
                ),
                (
                    "ended_at",
                    models.DateTimeField(
                        blank=True, help_text="When usage ended", null=True
                    ),
                ),
                (
                    "duration_seconds",
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Notes about this usage session"
                    ),
                ),
                (
                    "asset",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of this device"
                    ),
                ),
                (
                    "firmware_version",
                ...
                (
                    "is_online",
                    models.BooleanField(
                        default=False, help_text="Is the device currently online?"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Is this device active?"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "signature",
                    models.TextField(
                        help_text="Cryptographic signature of the firmware file"
                    ),
                ),
                (
                    "release_notes",
                    models.TextField(
                        blank=True, help_text="Release notes for this version"
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Is this firmware version active?"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "started_at",
                    models.DateTimeField(
                        blank=True, help_text="When update started", null=True
                    ),
                ),
                (
                    "completed_at",
                    models.DateTimeField(
                        blank=True, help_text="When update completed", null=True
                    ),
                ),
                (
                    "error_message",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Is this authorization active?"
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Notes about this authorization"
                    ),
                ),
                (
                    "asset",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="forgekey_po_device__e6d821_idx",
                    ),
                    models.Index(
                        fields=["asset", "timestamp"],
                        name="forgekey_po_asset_i_9626cf_idx",
                    ),
                    models.Index(
                        fields=["usage_session"], name="forgekey_po_usage_s_866913_idx"
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["mac_address"], name="forgekey_es_mac_add_7f2b3a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="esp32device",
            index=models.Index(
                fields=["device_type"], name="forgekey_es_device__5a6464_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="esp32device",
            index=models.Index(
                fields=["is_online"], name="forgekey_es_is_onli_f8b583_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="deviceusage",
            index=models.Index(
                fields=["asset", "user", "started_at"],
                name="forgekey_de_asset_i_36ceb2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="deviceusage",
            index=models.Index(
                fields=["started_at"], name="forgekey_de_started_90ba18_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="devicelockout",
            index=models.Index(
                fields=["locked_by"], name="forgekey_de_locked__481b17_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="devicefirmwareupdate",
            index=models.Index(
                fields=["device", "status"], name="forgekey_de_device__803112_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="devicefirmwareupdate",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["asset", "user", "is_active"],
                name="forgekey_as_asset_i_13bdff_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="assetauthorization",
