...
imports of breakers, or when LOTO requirements on a breaker change in a way
that didn't go through the admin signal path (e.g., direct SQL fixups).
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS("Derived {derived}, skipped {skipped}.".format(**summary))
        )
