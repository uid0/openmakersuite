          ...
          {relationships.map((rel, index) => (
            <Stack key={index} gap="xs" p="md" style={{ border: '1px solid #dee2e6', borderRadius: '4px' }}>
              ...
              <Group grow>
                <TextInput
                  label="Unit Cost"
                  description="Derived from package cost ÷ quantity. Change only this and it re-prices the package."
                  type="number"
                  value={rel.unit_cost || ''}
                  onChange={(e) =>
                ...
                <TextInput
                  label="Package Cost"
                  description="What you pay per package. If you change both, this one wins."
                  type="number"
