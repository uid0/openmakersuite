    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "donor_name",
                    models.CharField(
                        help_text="Name of the donor (individual or organization)", max_length=200
                    ),
                ),
                (
                    "donor_email",
                    models.EmailField(
                        blank=True, help_text="Donor email address (if available)", max_length=254
                    ),
                ),
                (
                    "donor_phone",
                    models.CharField(
                        blank=True, help_text="Donor phone number (if available)", max_length=50
                    ),
                ),
                (
                    "donor_address",
                    models.TextField(blank=True, help_text="Donor address (if available)"),
                ),
                (
                    "date_received",
                    models.DateField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When the donation was reviewed", null=True
                    ),
                ),
                (
                    "review_notes",
                    models.TextField(blank=True, help_text="Notes from the review process"),
                ),
                (
                    "estimated_value",
                    models.DecimalField(
                ...
                (
                    "cost_notes",
                    models.TextField(
                        blank=True, help_text="Notes about associated costs (what they were for)"
                    ),
                ),
                (
                    "tax_receipt_issued",
                    models.BooleanField(
                        default=False, help_text="Whether a tax receipt was issued to the donor"
                    ),
                ),
                (
                    "tax_receipt_number",
                    models.CharField(
                        blank=True, help_text="Tax receipt number (if issued)", max_length=100
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Name or description of the item", max_length=200),
                ),
                (
                    "description",
                ...
                (
                    "quantity",
                    models.PositiveIntegerField(default=1, help_text="Quantity of this item"),
                ),
                (
                    "condition",
                    models.CharField(
                ...
                ("notes", models.TextField(blank=True, help_text="Notes about this specific item")),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "asset",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "disposition_date",
                    models.DateField(
                        default=django.utils.timezone.now, help_text="Date the disposition occurred"
                    ),
                ),
                (
                    "sale_method",
                ...
                ("notes", models.TextField(blank=True, help_text="Notes about this disposition")),
                (
                    "recipient_name",
                    models.CharField(
                        blank=True,
        ...
        migrations.AddIndex(
            model_name="donation",
            index=models.Index(
                fields=["status", "-date_received"], name="donations_d_status_2a07ed_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="donation",
            index=models.Index(
                fields=["donor_name", "-date_received"], name="donations_d_donor_n_2b5e85_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="donation",
            index=models.Index(fields=["donation_number"], name="donations_d_donatio_aaa256_idx"),
        ),
        migrations.AddIndex(
            model_name="disposition",
            index=models.Index(
                fields=["donation_item", "-disposition_date"], name="donations_d_donatio_a29f01_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="disposition",
