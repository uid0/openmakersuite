    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("description", models.TextField(help_text="Description of the security concern")),
                (
                    "reported_at",
                    models.DateTimeField(
                ...
                (
                    "resolved_at",
                    models.DateTimeField(
                        blank=True, help_text="When the security report was resolved", null=True
                    ),
                ),
                (
                    "location",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "due_date",
                    models.DateTimeField(
                        blank=True, help_text="Optional due date for the task", null=True
                    ),
                ),
                (
                    "assigned_to",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "checked_in_at",
                    models.DateTimeField(auto_now_add=True, help_text="When the check-in occurred"),
                ),
                (
                    "notes",
                    models.TextField(blank=True, help_text="Optional notes about the check-in"),
                ),
                (
                    "location",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["location", "-reported_at"], name="location_ch_locatio_a82084_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="securityreport",
            index=models.Index(
                fields=["severity", "-reported_at"], name="location_ch_severit_197128_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="securityreport",
            index=models.Index(fields=["is_resolved"], name="location_ch_is_reso_92110e_idx"),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["location", "-submitted_at"], name="location_ch_locatio_85c606_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="locationfeedback",
            index=models.Index(
                fields=["feedback_type", "-submitted_at"], name="location_ch_feedbac_3b1d19_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="locationfeedback",
            index=models.Index(fields=["is_resolved"], name="location_ch_is_reso_c9b14b_idx"),
        ),
        migrations.AddIndex(
            model_name="locationcheckin",
            index=models.Index(
                fields=["location", "-checked_in_at"], name="location_ch_locatio_c935e4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="locationcheckin",
            index=models.Index(
                fields=["checkin_type", "-checked_in_at"], name="location_ch_checkin_a64908_idx"
            ),
        ),
    ]
