    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sku",
                    models.CharField(
                        blank=True, help_text="Internal SKU", max_length=100
                    ),
                ),
                (
                    "image",
                    imagekit.models.fields.ProcessedImageField(
                        blank=True, null=True, upload_to="inventory/images/"
                    ),
                ),
                (
                    "thumbnail",
                    imagekit.models.fields.ProcessedImageField(
                        blank=True, null=True, upload_to="inventory/thumbnails/"
                    ),
                ),
                (
                    "location",
                    models.CharField(
                        help_text="Physical location in makerspace", max_length=200
                    ),
                ),
                (
                    "reorder_quantity",
                ...
                (
                    "qr_code",
                    models.ImageField(
                        blank=True, null=True, upload_to="inventory/qrcodes/"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["item", "-usage_date"],
                        name="inventory_u_item_id_c8169c_idx",
                    )
                ],
            },
        ),
