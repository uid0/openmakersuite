...
class InventoryItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'image', 'thumbnail', 'category', 'category_name',
            'location', 'reorder_quantity', 'current_stock', 'minimum_stock',
            'supplier', 'supplier_name', 'supplier_sku', 'supplier_url', 'unit_cost',
            'average_lead_time', 'qr_code', 'is_active', 'notes',
            'needs_reorder', 'total_value', 'created_at', 'updated_at'
        ]
...
class InventoryItemDetailSerializer(InventoryItemSerializer):
    ...
    class Meta(InventoryItemSerializer.Meta):
        fields = InventoryItemSerializer.Meta.fields + [
            'recent_usage', 'supplier_details', 'category_details'
        ]
