...
**YOU ARE IN: `oms/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/oms/` (rig root) or other directories
...
**Your mail address:** `oms/polecats/obsidian`
**Your rig:** oms
**Your Witness:** `oms/witness`
...
| Ask Witness for help | `gt mail send oms/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`oms/witness`) when:
...
```bash
gt mail send oms/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
