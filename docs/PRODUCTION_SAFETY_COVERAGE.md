...
| Observability sink | At least one of Sentry / Highlight configured, https-only. | Mitigated | `scripts/validate-prod-env.sh:249-290` | `test_sentry_https_value_allowed`, `test_empty_sentry_value_allowed`, `test_observability_warning_when_highlight_and_sentry_both_unset`, `test_observability_warning_absent_when_highlight_or_sentry_present`. |
